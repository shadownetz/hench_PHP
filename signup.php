...
<?php require_once('set_signup.php') ?>
                ...
                <div class="col-sm-8 contact-block">
                    ...
                    <form action="#" method="POST" id="contact-form">
                        ...
                        <div class="form-group col-sm-6 padding-right">
                            ...
                            <input type="tel" class="form-control" name="phone" id="pnumber" required placeholder="Phone Number">
                        ...
                        <div class="col-sm-12 button no-padding">
                            ...
                            <input type="submit" name="signup" id="register" class="btn btn-default" value="Register">
