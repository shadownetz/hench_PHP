          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo $total_regs_counter; ?> <small><i class="fa fa-users"></i></small></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo $total_investments; ?><small><i class="fa fa-dollar"></i></small></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo $total_withdrawals; ?><small><i class="fa fa-dollar"></i></small></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
